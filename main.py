...
genres = pd.read_csv("genres.csv", index_col='genre').to_dict(
    orient='dict')['id']
actors = pd.read_csv("actors.csv", index_col='actor').to_dict(
    orient='dict')['id']
directors = pd.read_csv("directors.csv", index_col='director').to_dict(
    orient='dict')['id']
